...
const WaysToGrow = () => {
    ...
    return (
        <div className='w-full p-8'>
            ...
            <p className='text-sm mb-8'>TaskMaster's intuitive features give any team the ability to quickly set up and customize workflows for just about anything.</p>
