      ...
      <div className="modal">
        <div className="modal-box rounded-sm max-w-screen-md mx-2">
          ...
          <div className="grid grid-cols-4 -mr-4">
            <div className="px-6 dark:text-gray-100 col-span-4 md:col-span-3">
              <form
              ...
              <div className="text-grey">
                <div className="flex justify-between ">
                  ...
                  <Link
                    ...
                    href="#"
                    className="flex btn-ghost btn-sm text-black  items-center p-2 space-x-3 rounded-sm shadow-sm"
                  >
                    <p>Show Details</p>
                  </Link>
                </div>
                  ...
                  <form className="flex flex-col py-6 space-y-4 md:py-0 ng-untouched ng-pristine ng-valid">
                    <label className="block">
                      <textarea
                        ...
                        onChange={""}
                        rows="1"
                        className="block input input-bordered p-1 w-full rounded-sm outline-border"
                      ></textarea>
                    </label>
            ...
            <div className="col-span-1">
              <div className="h-full space-y-2 w-full dark:bg-gray-900 dark:text-gray-100">
                    ...
                    <li className="shadow-sm">
                      ...
                      >
                        <svg
                          ...
                          viewBox="0 0 512 512"
                          className="w-5 h-5 fill-current text-grey"
                        >
