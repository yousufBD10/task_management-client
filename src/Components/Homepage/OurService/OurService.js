        ...
        <div className='grid grid-cols-2 lg:px-12 items-center'>
            <div className=' lg:px-16 '>
                ...
                <div className='px-12 mt-12'>
                    <Link to="/register"><button className='border rounded-lg  hover:text-white  lg:h-12 text-xl font-bold lg:w-36 border-gray-500 bg-gray-200 hover:bg-blue-600'>Get Start</button></Link>
                </div>
            </div>
            <div>
